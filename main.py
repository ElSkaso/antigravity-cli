...
def finish():
    ...
    try:
        ...
        console.print(f"[bold green]✅ Success![/bold green] Task archived.")
...
def log(markdown: bool = False, export: bool = False):
    ...
    Optionen:
    --markdown: Gibt rohes Markdown aus (gut für Pipes).
    ...
    if export:
        ...
        console.print(f"[bold green]✅ Exported to {history_file.name}[/bold green]")
        return
